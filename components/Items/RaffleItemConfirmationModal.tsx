...
export default function RaffleItemConfirmationModal({
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-[1000]">
      <div className="w-[90%] sm:w-[75%] md:w-[60%] lg:w-[45%] flex flex-col items-center bg-white rounded shadow-lg">
        ...
        <div className="flex flex-col p-6 gap-6">
          <Image priority src={itemImageUrl} alt={`${itemName} 이미지`} width={400} height={400} />
